...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'parking_space.update': {
    roles: ['business-owner', 'parking-manager'],
    key: 'parking-space-update',
    tenantPath: ['organization', 'parking_space'],
    userPath: [],
  },
  'vehicle.create': {
    roles: ['business-owner', 'parking-manager', 'system-administrator'],
    key: 'vehicle-entry-logged',
    tenantPath: ['organization', 'user', 'vehicle'],
    userPath: [],
  },
  'ticket.create': {
    roles: ['business-owner', 'cashier', 'system-administrator'],
    key: 'ticket-generated',
    tenantPath: ['organization', 'user', 'vehicle', 'ticket'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'parking-manager', 'cashier', 'system-administrator'];
