        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Vehicle Number" text={data?.vehicle_number} />

                <FormListItem
                  label="Entry Time"
                  text={data?.entry_time ? format(parseISO(data?.entry_time as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem
                  label="Exit Time"
                  text={data?.exit_time ? format(parseISO(data?.exit_time as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Parking Cost" text={data?.parking_cost} />
